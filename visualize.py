...
def visualize_frames(video_data, output_dir, num_frames=15, frame_rate=30, total_window=3):
    ...
    for i in range(data_points):  # Loop over each sample in the batch
        fig, axes = plt.subplots(3, 5, figsize=(15, 9))  # 3 rows, 5 columns for each sample
...
visualize_frames(video_data, output_dir, num_frames=15, total_window=3)
